...
def open_window(width, height):
	...
	cv2.resizeWindow(SIZE_NAME, BIG_WIDTH, BIG_HEIGHT)
	cv2.moveWindow(SIZE_NAME, BIG_POSX, BIG_POSY)
	
	cv2.resizeWindow(CANNY_NAME, SMALL_WIDTH, SMALL_HEIGHT)
	cv2.moveWindow(CANNY_NAME, SMALL_POSX, SMALL_HEIGHT + 100)
	
	cv2.resizeWindow(WINDOW_NAME, SMALL_WIDTH, SMALL_HEIGHT)
	cv2.moveWindow(WINDOW_NAME, SMALL_POSX, SMALL_POSY)
...
####### GOT THE SIZES!
		...
		cv2.putText(img, '{:s} {:f}'.format(class_desc, confidence*100), (11, 50), font,
						4.0, (0,0,0), 6, cv2.LINE_AA)
		cv2.putText(img, '{:s} {:f}'.format(class_desc, confidence*100), (10, 50), font,
						4.0, (255,255,255), 3, cv2.LINE_AA)
		cv2.imshow(WINDOW_NAME, img)
		
		cv2.resizeWindow(SIZE_NAME, SMALL_WIDTH, SMALL_HEIGHT)
		cv2.moveWindow(SIZE_NAME, SMALL_POSX, SMALL_POSY)
		
		cv2.resizeWindow(CANNY_NAME, SMALL_WIDTH, SMALL_HEIGHT)
		cv2.moveWindow(CANNY_NAME, SMALL_POSX, SMALL_HEIGHT + 100)
		
		cv2.resizeWindow(WINDOW_NAME, BIG_WIDTH, BIG_HEIGHT)
		cv2.moveWindow(WINDOW_NAME, BIG_POSX, BIG_POSY)
